...
each graded piece $(J^0_\partial M)_d$ is finite dimensional,
and the Hilbert--Poincar\'{e} series
\begin{equation*}
  HP_{J^0_\partial M}(t) = \sum_{d \in \mathbb{N}} \dim_k((J^0_\partial M)_d)\, t^d
\end{equation*}
is well defined.
