...
\begin{align}
  ...
  \label{eq:5}
  \partial(t^i) &= t^{i + 1}, \qquad i \in \mathbb{N}.
\end{align}
...
\begin{equation*}
  F_r(X_1^{(0)} + X_1^{(1)}t + \dots, \dots, X_n^{(0)} + X_n^{(1)}t + \dots) = G_r^{(0)} + G_r^{(1)}t + \dots, \qquad r = 1, \dots, m,
\end{equation*}
where $G_r^{(i)} \in k[X^{(i)}_j \mid i \in \mathbb{N}, j = 1, \dots, n], i \in \mathbb{N}, r = 1 \dots, m$.
Then
\begin{equation}
  \label{eq:7}
  JA = \frac{k[X^{(i)}_j \mid i \in \mathbb{N}, j = 1, \dots, n]}{(G^{(i)}_r \mid i \in \mathbb{N}, r = 1 \dots, m)}.
\end{equation}
Setting
\begin{equation*}
  H^{(i)}_r = G_r^{(i)}|_{X^{(0)}_j = 0, j = 1 \dots, n} \in k[X^{(i)}_j \mid i \in \mathbb{Z}_+, j = 1, \dots, n], \qquad i \in \mathbb{Z}_+, r = 1 \dots, m,
\end{equation*}
we have
\begin{equation}
  \label{eq:8}
  J^0A = J^\mathfrak{p}A = JA \otimes_A k = \frac{k[X^{(i)}_j \mid i \in \mathbb{Z}_+, j = 1, \dots, n]}{(H^{(i)}_r \mid i \in \mathbb{Z}_+, r = 1, \dots, m)}.
\end{equation}
